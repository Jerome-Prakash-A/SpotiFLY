import { Alert, Image, StyleSheet, Text, TextInput, TouchableOpacity, useWindowDimensions, View, TextComponent } from 'react-native'
...
export default function SignupScreen({navigation}) {
    ...
    return (
        ...
        <View style={styles.entireScreen}>
            ...
            <Text style={{fontSize:45,fontStyle:'italic', color:'blue',marginBottom:80, fontWeight:'500'}}>
                SpotiFLY
            </Text>
